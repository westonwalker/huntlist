...
class PlaceFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $schema = [
            ...
            'hunting_description' => $this->faker->paragraph(),
            'fishing_description' => $this->faker->paragraph(),
            'hunting_acres' => 5023,
            'fishing_acres' => 1756,
            'hunting_info' => 'https://huntillinois.org/sites/pekin-lake-sfwa/',
            'fishing_info' => 'https://huntillinois.org/sites/pekin-lake-sfwa/',
            'animal_list' => 'Deer, Turkey',
            'fish_list' => 'Muskee, Bluegill, Black Crappie, Bass',
            'boat_fishing' => 'Unrestricted',
            'has_boat_ramps' => true,
            'average_water_depth' => '22.4 ft',
            'catch_limits' => 'https://ifishillinois.org/profiles/waterbody.php?waternum=04666',
            'contact_number' => '217-452-7741',
            'state_id' => 1,
